...
print(name[2]) # the 3d element: v
print(name[1:3]) # from the 2nd to 3d element: av
# str[start:end:step]
print(name[0:len(name):2]) # similar
print(name[:len(name):2]) # similar
print(name[0::2]) # similar
print(name[::2]) # similar
...
print("*********************************** methods on string")

s = "Coral is either the stupidest animal or the smartest rock. Next time"
d = "1234"
print(s.isdigit())
print(d.isdigit())
...
print(s.count("e")) # how many times "e" is in the string s
print(s.count(" the "))
print(s.index("C"))
print(s.upper())
print(s.lower())
...
name = "Jackson-Ross Eva-Maria"
last_name1, first_name1 = name.split()
print(last_name1)
print(first_name1)
middle_name, first_name1 = first_name1.split("-")
print(middle_name)
print(first_name1)
